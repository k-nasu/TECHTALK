  ...
  return (
    <nav
      className={`
        ...
        transition-transform duration-30 shadow-lg shadow-gray-100
        ${isVisible ? 'translate-y-0' : '-translate-y-full'}
      `}
    >
      <div className="container px-4 lg:w-4/5 mx-auto h-16 flex items-center justify-between bg-white/5 backdrop-blur-sm">
